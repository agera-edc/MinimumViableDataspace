...
locals {
  ...
  registration_service_host         = "http://${local.registration_service_dns_label}.${var.location}.azurecontainer.io"
  registration_service_url         = "${local.registration_service_host}:${local.registration_service_port}${local.registration_service_path_prefix}"
